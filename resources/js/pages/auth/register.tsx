      ...
      <main className="w-full max-w-[480px] z-10 animate-in fade-in duration-700 slide-in-from-bottom-4">
        ...
        <div className="glass-panel bg-card p-6 md:p-lg rounded-xl shadow-2xl border border-border">
          <div className="mb-6 md:mb-lg">
            <h2 className="text-lg md:font-headline-sm md:text-headline-sm font-semibold text-card-foreground mb-1">Buat Akun</h2>
            <p className="text-xs md:font-body-sm md:text-body-sm text-muted-foreground">Bergabunglah dengan jaringan akademik kami dan mulai kelola data.</p>
          </div>

          <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-1.5 md:space-y-2">
              <label className="text-[10px] md:font-label-md md:text-label-md text-muted-foreground uppercase tracking-wider font-semibold" htmlFor="name">Nama Lengkap</label>
            ...
            <div className="space-y-1.5 md:space-y-2">
              <label className="text-[10px] md:font-label-md md:text-label-md text-muted-foreground uppercase tracking-wider font-semibold" htmlFor="email">Email Institusi</label>
              <div className="relative group">
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              <div className="space-y-1.5 md:space-y-2">
                <label className="text-[10px] md:font-label-md md:text-label-md text-muted-foreground uppercase tracking-wider font-semibold" htmlFor="password">Kata Sandi</label>
                <div className="relative group">
          ...
          <div className="text-center mt-6 pt-4 border-t border-border">
            <p className="text-sm text-muted-foreground">
              Sudah punya akun? <Link className="text-primary font-semibold hover:underline transition-all ml-1" href="/login">Masuk di sini</Link>
            </p>
          </div>
        </div>
      </main>
