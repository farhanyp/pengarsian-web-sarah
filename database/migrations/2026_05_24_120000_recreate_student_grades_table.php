...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error("Migration up failed for recreating grades/categories tables: " . $e->getMessage());
            throw $e;
        }
    }
    ...
    public function down(): void
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error("Migration down failed for recreating grades/categories tables: " . $e->getMessage());
            throw $e;
        }
    }
};
